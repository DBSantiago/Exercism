...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    actual_exchange_rate = exchange_rate + (exchange_rate * spread / 100)
    exchanged_value = exchange_money(budget,actual_exchange_rate)
    number_of_bills = exchanged_value / denomination

    return get_value_of_bills(denomination,number_of_bills) - exchangeable_value(budget, exchange_rate, spread, denomination)